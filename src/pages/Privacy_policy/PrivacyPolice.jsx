...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <PageMetaData
        title={t("privacy_policy_meta_title")}
        description={t("privacy_policy_meta_title")}
      />
          ...
          <div className="w-[80%] mx-auto">
            ...
            >
              ...
              <h2>
                ...
                >
                  <span>{t("info_we_collect_title")}</span>
                  <svg
                    data-accordion-icon
              ...
              <h2>
                ...
                >
                  <span>{t("data_sharing_title")}</span>
                  <svg
                    data-accordion-icon
                    className="w-3 h-3 rotate-180 shrink-0"
                    xmlns="http://www.w3.org/2000/svg"
