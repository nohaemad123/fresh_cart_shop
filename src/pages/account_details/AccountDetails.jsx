    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row mt-5 gap-x-5">
        <div className="relative w-fit">
          <img
            src={author_image}
            className="size-30 border-5 border-gray-300 dark:border-gray-600 rounded-full"
          />
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex gap-x-3">
            ...
            <button className="py-2 px-3 border cursor-pointer border-primary-600 text-sm text-primary-600 dark:text-primary-400 font-semibold text-center rounded-md">
              {t("cancel")}
            </button>
          </div>
      ...
      <div className="mt-5 border-t border-gray-300 dark:border-gray-700 pt-5">
        <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
