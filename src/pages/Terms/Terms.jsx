        ...
        <div className="container">
          <div className="w-[80%] mx-auto">
            ...
            <div className="flex flex-col my-10 space-y-2">
              ...
              <p className="text-gray-500">{t("terms_of_services_desc")}</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 space-y-5 lg:space-x-10">
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("acceptance_of_terms_desc")}</p>
              </div>
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("products_pricing_desc")}</p>
              </div>
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("orders_desc")}</p>
              </div>
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("payments_desc")}</p>
              </div>
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("shipping_delivery_desc")}</p>
              </div>
              ...
              <div className="flex flex-col space-y-2 bg-white p-5 rounded-xl shadow-md">
                ...
                <p className="text-gray-500">{t("returns_refunds_desc")}</p>
              </div>
