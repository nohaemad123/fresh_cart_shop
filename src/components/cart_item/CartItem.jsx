...
export default function CartItem({ cartProduct, updateCountProductsApi }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-x-5 mb-5 border-b border-gray-300 dark:border-gray-600 pb-5 last:border-0">
      <div className="md:col-span-6 lg:col-span-7 px-5 md:px-10 items-center">
        <div className="flex gap-x-5 items-center">
          ...
          <div className="flex flex-col space-y-2 mb-3 lg:mb-0">
            <Link to={`/product-details/${product._id}`}>
              <h3 className="text-[18px] font-medium hover:text-primary-600 transition-colors duration-500 dark:text-gray-100">
                {product.title}
              </h3>
            </Link>
        ...
        <div className="flex gap-x-3 justify-end items-center">
          <div className="flex items-center border-2 border-gray-200 dark:border-gray-700 rounded-lg">
            <button
              ...
              className="py-1 cursor-pointer border-r-2 border-gray-200 dark:border-gray-700 px-2 text-2xl font-semibold dark:text-gray-200"
            >
              -
            </button>
            <span className="py-1 px-4 text-xl dark:text-gray-100">
              {count}
            </span>
            <button
              onClick={handleIncrease}
              className="py-1 px-2 cursor-pointer border-l-2 border-gray-200 dark:border-gray-700 text-2xl font-semibold dark:text-gray-200"
            >
              +
            </button>
          </div>
          <h4 className="text-lg font-semibold text-center dark:text-gray-100">
            {cartProduct.price} {t("egp")}
          </h4>
          <button
            className="text-red-600 dark:text-red-500/90 cursor-pointer"
